...
<div style="background-color:orangered; color:#00303f;">
    ...
    <h5 align="center" style="font-family: Algerian; font-size: 80px; height: 100px; color:black;" >VAN DRIVER LOGIN</h5>

</div>
<br>
<div style="color: black; ">
    <h3>
        <a href="HomePage.php" style=" font-size: 25px; margin-left: 10px;"><font color="#8b4513">Home</font></a><br><br>
        <a href="SignUp.php" style=" font-size: 25px; margin-left: 10px;"><font color="#8b4513">SignUp</font></a>
        </br>
    </h3>
</div>
<br>

...
<body style="background-color:orange;">
    <div style="background-color:orangered; color:#00303f;">

        <h5 align="center" style="font-family: Algerian; font-size: 80px; height: 100px;" >CSTS ADD VANS</h5>
...
<div  >
	...
	<div style="color: black; ">
        <h3 >
            <a href="HomePage.php" style=" font-size: 25px; margin-left: 10px;"><font color="#8b4513">HOME</font></a>
            </br>
        </h3>
    </div>
    <br>
	...
	<div  style="color:#000000; background-color:#F2F2F2; width: 75%">
			<form  action="InsertItems.php" method="post" name="myForm" onsubmit = "formValidate()" enctype="multipart/form-data">
				...
				<table >
                        <br>
						<h1 style="text-align: center; color: black"><b>ADD NEW VAN</b></h1>
		                <br>

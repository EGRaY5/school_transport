...
<html>
<head>
	<TITLE>CSTS PROFILE</title>
    <link rel="stylesheet" type="text/css" href="CarNew.css" />

</head>

<body style="background-color:orange;">
<div style="background-color:orangered; color:black;">
...
<div style="color: black; ">
    <h3>
        <a href="HomePageLogin.php" style=" font-size: 25px; margin-left: 10px;"><font color="#8b4513">Home</font></a><br><br>
